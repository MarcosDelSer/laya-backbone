...
/**
 * Invoices page with internationalization support.
 *
 * Displays a list of invoices with summary statistics,
 * using Quebec currency formatting and translated text.
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500">
                {t('invoices.invoiceCount', { count: pendingCount })}
              </p>
            </div>
        ...
        <div className="card p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500">
                {t('invoices.invoiceCount', { count: overdueCount })}
              </p>
            </div>
        ...
        <div className="card p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500">
                {t('invoices.summary.paidThisYear')}
              </p>
              <p className="text-2xl font-bold text-green-600">
                {formatCurrency(totalPaid)}
              </p>
              <p className="text-xs text-gray-500">
                {t('invoices.invoiceCount', { count: paidCount })}
              </p>
            </div>
      ...
      <div className="mb-6 flex flex-wrap gap-2">
        ...
        >
          {t('common.all')} ({mockInvoices.length})
        </button>
        {pendingCount > 0 && (
          <button
            type="button"
