...
/**
 * Documents page with internationalization support.
 *
 * Displays a list of documents for the parent to review and sign,
 * with filtering capabilities and signature capture.
    ...
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mb-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <Link href={`/${locale}`} className="btn btn-outline self-start">
            <svg
      ...
      <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
        ...
        <div className="card p-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-sm text-gray-500">
                {t('documents.summary.pendingSignatures')}
              </p>
        ...
        <div className="card p-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-sm text-gray-500">
                {t('documents.summary.signedDocuments')}
              </p>
      ...
      <div className="mb-6 flex items-center justify-between">
        <h2 className="section-title">{t('documents.documentLibrary')}</h2>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-yellow-800">
                {t('documents.actionRequired.title')}
              </h3>
              <p className="mt-1 text-sm text-yellow-700">
                {t('documents.actionRequired.description', { count: pendingCount })}
              </p>
            </div>
          </div>
        </div>
      ...
      {filteredDocuments.length > 0 ? (
        ...
        <div className="rounded-lg border-2 border-dashed border-gray-200 p-12 text-center">
          ...
          <p className="mt-2 text-sm text-gray-500">
            {filter === 'pending'
              ? t('documents.noDocumentsDescription.pending')
              : filter === 'signed'
                ? t('documents.noDocumentsDescription.signed')
                : t('documents.noDocumentsDescription.all')}
          </p>
          {filter !== 'all' && (
            <button
              type="button"
