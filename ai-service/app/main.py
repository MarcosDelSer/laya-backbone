...
from app.routers.director_dashboard import router as director_dashboard_router
...
app.include_router(director_dashboard_router, prefix="/api/v1/director", tags=["director"])
