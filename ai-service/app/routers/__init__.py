...
Modules:
    ...
    documents: Router for document e-signature and template management endpoints
"""
...
__all__: list[str] = ["coaching_router", "activities_router", "analytics_router", "documents_router"]
