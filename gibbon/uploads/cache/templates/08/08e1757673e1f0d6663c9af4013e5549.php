...
/* ui/tabs.twig.html */
class __TwigTemplate_b57202602862139a75b2343daa0f0b1f extends Template
{
    private $source;
    private $macros = [];
    ...
    id=\"";
        // line 25
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((array_key_exists("id", $context)) ? (Twig\Extension\CoreExtension::default(($context["id"] ?? null), "tabs")) : ("tabs")), "html", null, true);
        yield "\">
    ...
    <div class=\"overflow-y-hidden w-full\">
        ...
        foreach ($context['_seq'] as $context["tabID"] => $context["tab"]) {
            ...
            yield "            <button :id=\"\$id(tabId)\" @click=\"tabButtonClicked(\$el);\" :aria-selected=\"tabActive(\$el)\" type=\"button\" :class=\"tabActive(\$el) ? 'text-gray-900 border border-gray-400 border-b-white z-10 bg-white shadow' : 'text-gray-800 hover:bg-gray-200 border border-transparent hover:border-b-gray-400 bg-transparent'\" class=\"inline-flex flex-col sm:flex-row gap-1.5 items-center px-4 sm:px-5 xl:px-6 py-2 -mr-1 sm:-mr-2 font-normal rounded-t-md  \" role=\"tab\" tabindex=\"tabActive(\$el) ? '0' : '-1'\" aria-selected=\"true\">
                ";
            // line 31
            if ((($context["icons"] ?? null) && CoreExtension::getAttribute($this->env, $this->source, $context["tab"], "icon", [], "any", false, false, false, 31))) {
                // line 32
                yield "                    <span x-cloak x-show=\"tabActive(\$el.parentElement)\" class=\"inline-flex\">
                    ";
                // line 33
                yield $this->env->getFunction('icon')->getCallable()("solid", CoreExtension::getAttribute($this->env, $this->source, $context["tab"], "icon", [], "any", false, false, false, 33), "inline-block size-5  sm:-ml-1 opacity-50");
                yield "
                    </span>
                    <span x-show=\"!tabActive(\$el.parentElement)\" class=\"inline-flex\">
                        ";
                // line 36
                yield $this->env->getFunction('icon')->getCallable()("outline", CoreExtension::getAttribute($this->env, $this->source, $context["tab"], "icon", [], "any", false, false, false, 36), "inline-block size-5  sm:-ml-1 opacity-50", ["stroke-width" => 1.5]);
                yield "
                    </span>
                ";
            }
            ...
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["tab"], "label", [], "any", false, false, false, 39), "html", null, true);
            yield "</span>
            </button>
    ...
    <div role=\"tabpanels\" class=\"h-full pt-4 -mt-px ";
        ...
        foreach ($context['_seq'] as $context["tabID"] => $context["tab"]) {
           ...
           ";
            // line 49
            yield CoreExtension::getAttribute($this->env, $this->source, $context["tab"], "content", [], "any", false, false, false, 49);
            yield "
        </div>
        ";
        }
...
";
    ...
    {
        return array (  130 => 52,  121 => 49,  118 => 48,  114 => 47,  110 => 46,  105 => 43,  94 => 39,  88 => 36,  82 => 33,  79 => 32,  77 => 31,  74 => 30,  70 => 29,  63 => 25,  57 => 24,  42 => 12,  38 => 10,);
    }
