...
class __TwigTemplate_0db9240b04b917e8ee90bf3fd90cc37c extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        ";
            ...
            ";
                ...
                <div class=\"sm:grid ";
                    // line 53
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((array_key_exists("gridClass", $context)) ? (Twig\Extension\CoreExtension::default(($context["gridClass"] ?? null), "grid-cols-2 sm:grid-cols-3")) : ("grid-cols-2 sm:grid-cols-3")), "html", null, true);
                    yield " rounded border bg-gray-50 text-xs text-gray-700\">
                ...
                ";
                    ...
                    <div class=\"px-4 py-4 border-b -mb-px ";
                        ...
                        yield "\" >
                        <span class=\"block text-sm text-gray-700 font-semibold mb-1.5\">";
                        // line 59
                        yield CoreExtension::getAttribute($this->env, $this->source, $context["column"], "getLabel", [], "any", false, false, false, 59);
                        yield "</span>
                        <span class=\"block text-sm text-gray-700 overflow-x-auto\">";
                        // line 60
