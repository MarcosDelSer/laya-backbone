...
/* index.twig.html */
class __TwigTemplate_84a0b91dd21d775423e5a4604e176b2d extends Template
{
    private $source;
    private $macros = [];
...
<html lang=\"";
    ...
    <body x-data=\"{ modalOpen: false, modalType: 'none', globalShowHide: false }\"
        ...
        yield "\" @modalwindow=\"modalType=\$event.detail; modalOpen = true\">
        <a id=\"top\"></a>
        ";
        // line 23
...
<html lang=\"{{ lang }}\" dir=\"{{ rightToLeft ? 'rtl' : 'ltr' }}\" style=\"scroll-behavior: smooth;\">
    ...
    <body x-data=\"{ modalOpen: false, modalType: 'none', globalShowHide: false }\"
        class=\"h-full flex flex-col font-sans {{ bodyBackground  ? '' : 'body-gradient-' ~ themeColour|lower }}\" style=\"{{ bodyBackground  ? bodyBackground : '' }} {{ themeColour is empty ? 'background: linear-gradient(to left top, #402568 2%, #935ee1 65%, #a871ec) no-repeat fixed' : '' }}\" @modalwindow=\"modalType=\$event.detail; modalOpen = true\">
        <a id=\"top\"></a>
