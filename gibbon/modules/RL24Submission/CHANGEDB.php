...
INSERT INTO `gibbonSetting` (`scope`, `name`, `nameDisplay`, `description`, `value`) VALUES ('RL-24 Submission', 'providerAddress', 'Provider Address', 'Official street address for RL-24 forms', '') ON DUPLICATE KEY UPDATE scope=scope;end
INSERT INTO `gibbonSetting` (`scope`, `name`, `nameDisplay`, `description`, `value`) VALUES ('RL-24 Submission', 'providerCity', 'Provider City', 'City where the provider is located', '') ON DUPLICATE KEY UPDATE scope=scope;end
INSERT INTO `gibbonSetting` (`scope`, `name`, `nameDisplay`, `description`, `value`) VALUES ('RL-24 Submission', 'providerPostalCode', 'Provider Postal Code', 'Postal code in Canadian format (e.g., H2X 1Y4)', '') ON DUPLICATE KEY UPDATE scope=scope;end
