 ...
 * - parent-app/src/screens/LoginScreen.tsx for screen structure
...
function LoginScreen(): React.JSX.Element {
  ...
  const handleLogin = useCallback(async () => {
    ...
    // Teacher-app uses different login signature: (credentials, rememberMe)
    await login(
      {
        email: email.trim(),
        password,
      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <ScrollView
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Sign in to continue to LAYA Teacher</Text>
          </View>
