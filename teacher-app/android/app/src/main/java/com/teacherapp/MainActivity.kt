...
/**
 * MainActivity is the entry point for the LAYA Teacher Android app.
 *
 ...
 * - Handle deep linking from the laya-teacher:// scheme
...
class MainActivity : ReactActivity() {
     ...
     * AppRegistry.registerComponent('TeacherApp', ...)
     */
    override fun getMainComponentName(): String = "TeacherApp"
