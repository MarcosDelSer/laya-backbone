...
struct ChildFormView: View {
    ...
    private func saveChild() {
        ...
        let request = ChildRequest(
            ...
            primaryGuardianName: primaryGuardianName.trimmingCharacters(in: .whitespaces),
            primaryGuardianEmail: primaryGuardianEmail.nilIfBlank,
            primaryGuardianPhone: primaryGuardianPhone.nilIfBlank,
            secondaryGuardianId: secondaryGuardianId.nilIfBlank,
            secondaryGuardianName: secondaryGuardianName.nilIfBlank,
