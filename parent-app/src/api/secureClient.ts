/**
 * LAYA Parent App - Secure API Client
 *
 ...
 * - parent-app/src/api/client.ts (base API client)
 * - parent-app/src/utils/secureStorage.ts (secure storage)
 * - parent-portal/lib/api/client.ts (type-safe validation)
 */
...
export const authApi = {
  ...
  getCurrentUser: async (): Promise<ApiResponse<any>> => {
    return secureApiRequest<any>(API_CONFIG.endpoints.auth.me, {
      method: 'GET',
    });
  },
