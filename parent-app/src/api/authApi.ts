/**
 * LAYA Parent App - Authentication API
 *
 * API functions for parent authentication including login, logout,
 ...
 * In production, use secure storage (Keychain for iOS).
 */
 ...
 *
 * @returns Promise with parent user profile
 *
 * @example
 * ```ts
...
): Promise<{user: Parent; accessToken: string; refreshToken: string} | null> {
